function getSplitName(personName) {
  ...
  //TESTING
  console.log(getSplitName("Dhea Juliani Apendi"));
  console.log(getSplitName("Dhea Juliani"));
  console.log(getSplitName("Dhea"));
  console.log(getSplitName("Dhea Juliani Apendi Dwi"));
